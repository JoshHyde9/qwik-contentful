...
export const BlogCard = component$<CardProps>(
  ({ title, description, publishedDate, readingTime, previewImage }) => (
    <div class="flex flex-row justify-between items-center my-5 py-5 rounded-xl transition-colors duration-300 md:px-5 md:gap-6 hover:bg-global-warming/25 dark:hover:bg-neutral-600/25">
