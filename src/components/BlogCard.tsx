...
export const BlogCard = component$<CardProps>(
  ({ title, description, publishedDate, readingTime, previewImage }) => (
    <div class="flex flex-row justify-between items-center gap-6 my-5 p-5 rounded-xl transition-colors duration-300 hover:bg-global-warming/25 dark:hover:bg-neutral-600/25">
